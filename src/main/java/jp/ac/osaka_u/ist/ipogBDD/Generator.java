...
class GeneratorFactory {
	...
	static Generator newGenerator(ParameterModel parametermodel,
		...
		try {
			if (Main.handler == Main.Handler.NO) {
				return new IPOGnoconst(parametermodel, groupList, constrainthandler,
						seed, randomseed,strength);
			}
			else {
				return new IPOG(parametermodel, groupList, constrainthandler,
						seed, randomseed,strength);
			}
		} catch (Exception e) {
...
//	static final int MaxNumOfTestcases = 65532;
	static final int MaxNumOfTestcases = 10000;
//	static final int MaxNumOfTestcases = 2000;
...
//			NewBDDConstraintHandler constrainthandler, List<Testcase> seed,
//			long randomseed) {
...
//			int numCovered = 0;
//			int v1 = temptest.get(p1);
//			if (v1 < 0)
//				continue;
//			for (int p2 = 0; p2 < this.parametermodel.size; p2++) {
//				if (p1 == p2)
//					continue;
//				int v2 = temptest.get(p2);
//				if (v2 < 0)
//					continue;
//				if (tab.get(p1, v1, p2, v2) == false)
//					numCovered++;
...
//	}
//
//	boolean get(int p1, int v1, int p2, int v2) {
//		if (p2 < p1) {
//			int tmp = p1;
//			p1 = p2;
//			p2 = tmp;
...
//
//	// 現れない場合．すでにカバーした場合
//	void set(int p1, int v1, int p2, int v2) {
//		if (p2 < p1) {
//			int tmp = p1;
//			p1 = p2;
//			p2 = tmp;
